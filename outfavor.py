...
def team_ana(scope):
    ...
    nc=0.0
    buf=0
    team_f=open("outfavor"+str(scope)+".txt",'a')
    ...
    team_draw=np.genfromtxt("./outfavor"+str(scope)+".txt",delimiter=' ',names=['foo','bar','br','bu','bc','nr','nu','nc'])
#    print(team_draw['bu'])
# Create the plot
...
# Save the figure in a separate file
    plt.savefig("outfavor"+str(scope)+".png")
