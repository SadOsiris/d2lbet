...
do
  ...
  then
  echo ping
  echo null > winning-team
  echo null> losing-team
...
#  paste idx winning-team losing-team first-team second-team winning-team-idx favor-left favor-right odds bo| awk '(NF>=0) {print}' >> data-fail-new
 ...
 # paste idx winning-team losing-team first-team second-team winning-team-idx favor-left favor-right odds bo| awk '{print $0}' > bo2bad
  #paste idx winning-team losing-team first-team second-team winning-team-idx favor-left favor-right odds bo >> bo2bad

  paste idx winning-team losing-team first-team second-team winning-team-idx favor-left favor-right odds bo| awk '($15==2) {print}' >> bo2-new
  paste idx winning-team losing-team first-team second-team winning-team-idx favor-left favor-right odds bo| awk '($17==2) {print}' >> bo2-new
